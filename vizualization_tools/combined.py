...
categories = ["interior", "exterior", "ground", "raised", "aerial"]
initial_model_accuracy = [79.81, 90.24, 88.23, 75.13, 76.86]
retrained_model_accuracy = [80.01, 90.42, 88.79, 76.02, 77.10]
...
ax.set_title('Trained and Retrained Model Accuracy per Image Categories', fontsize=16, pad=20)  # Added 'pad' for spacing after the title
